...
export function ForumPreviewSection() {
  return (
    <section
      id="forum-preview"
      className="mx-auto w-full max-w-6xl px-6 py-8 sm:px-8 lg:px-12"
    >
      <div className="grid gap-6 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
        <div className="rounded-[2rem] bg-[var(--surface-strong)] p-7 shadow-[var(--shadow)] ring-1 ring-[var(--line)]">
          ...
          <div className="mt-6 space-y-4">
            {postingLanes.map((lane, index) => (
              <div
                key={lane.title}
                className="rounded-[1.4rem] bg-white px-5 py-5 ring-1 ring-[var(--line)]"
              >
        ...
        <div className="rounded-[2rem] bg-white p-7 shadow-[var(--shadow)] ring-1 ring-[var(--line)]">
          ...
          <div className="mt-8 space-y-3">
            {recentThreads.map((thread) => (
              <div
                key={thread.title}
                className="grid gap-3 rounded-[1.4rem] bg-[var(--surface-soft)] px-5 py-4 ring-1 ring-[var(--line)] sm:grid-cols-[minmax(0,1fr)_auto]"
              >
                <div>
